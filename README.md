...
We use the names DatongToken and AnarchoToken interachangeably, for different audiences. In terms of implementation, the name Anarchoverse captures the imagination much easier, so that we can recruit as many collaborators as possible, as soon as possible.
